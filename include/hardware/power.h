...
typedef enum {
    ...
    POWER_FEATURE_DRAW_S = 0x00000008,
    POWER_FEATURE_DRAW_ARROW_LEFT = 0x00000009,
    POWER_FEATURE_DRAW_ARROW_RIGHT = 0x0000000A,
    POWER_FEATURE_ONE_FINGER_SWIPE_UP = 0x0000000B,
    POWER_FEATURE_ONE_FINGER_SWIPE_RIGHT = 0x0000000C,
    POWER_FEATURE_ONE_FINGER_SWIPE_DOWN = 0x0000000D,
    POWER_FEATURE_ONE_FINGER_SWIPE_LEFT = 0x0000000E,
    POWER_FEATURE_TWO_FINGER_SWIPE = 0x0000000F
} feature_t;
